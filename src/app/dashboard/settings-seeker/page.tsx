...
import { ArrowLeft, BriefcaseBusiness, ChevronRight, Gem, Trash2, User } from 'lucide-react'
    ...
    return (
        <div className="max-w-4xl  p-6 md:ml-6 mx-auto">
            ...
            <div className="w-full max-w-md  text-black/80 font-sans rounded-md overflow-hidden">
                ...
                {/* Row 3 */}
                <div onClick={()=>setOpen(true)} className="flex items-center justify-between px-4 py-4 border-b border-[#E8E7E7] cursor-pointer ">
                    <div className='flex items-center gap-2'>
                        <Gem size={20} />
                            ...
                            <div className="flex items-start justify-between py-2">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 max-w-xs">
                                        Get response when legal AI response to requests that take time or
                                        consultation responses when you are offline
                                    </p>
                                </div>
                                <Switch
