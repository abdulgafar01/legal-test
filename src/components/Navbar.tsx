...
const Navbar = ({ isMobile, showMobileMenu, toggleSidebar }: NavbarProps) => {
  ...
  {/* Right Section */}
      <div className="flex items-center gap-4 ml-auto">
          ...
          {/* Notification Bell */}
          <Button variant="ghost" size="sm" className="relative p-2 bg-amber-100 rounded-3xl hover:bg-amber-200 cursor-pointer">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
                <Link href="/dashboard/profile" title="View Profile" className='cursor-pointer p-2'>  
